...
# --- Contact Us Page ---
    ...
    with col1:
        st.image(r"ARKA.jpg", caption="ARKA SADHUKHAN", width=150)
    ...
    with col2:
        st.image(r"MANAMI.jpg", caption="MANAMI MANNA", width=150)
    ...
    with col3:
        st.image(r"SOUMYAJIT.jpg", caption="SOUMYAJIT ROY", width=150)
